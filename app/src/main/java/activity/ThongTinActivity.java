...
import com.example.doanqx.databinding.ActivityThongtinBinding;
...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng HappRoom = new LatLng(10.841749910516707, 106.77302385471259);
        mMap.addMarker(new MarkerOptions().position(HappRoom).title("Happy Room of 5 Boy").snippet("26/3 phan Chu Trinh, Hiệp Phú, Quận 9").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(HappRoom).zoom(90).build();
